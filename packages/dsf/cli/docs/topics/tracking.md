...
A normal serial scheduler should strongly prefer a ready Milestone Review before starting another ordinary Phase. Independent Phase work may still continue. Already-active work is not interrupted solely because a Review became ready.
...
This release implements no write-oriented Delivery commands. Tracking remains external.
