...
Recommended next work: [PROP-005 — DLE Distribution Kit](./PROP-005-dle-distribution-kit.md) (priority 3).

## Unfinished design work

| Proposal                                                                                | Status         | Work state | Priority | Direct dependencies                | Eligibility                   | Summary                                                                                                                                                                                                                     |
| --------------------------------------------------------------------------------------- | -------------- | ---------- | -------- | ---------------------------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [PROP-003 — DWF project instance workflow](./PROP-003-dwf-project-instance-workflow.md) | `design-draft` | `PLANNED`  | 3        | `PROP-002`, `PROP-005`             | blocked by PROP-005           | Define the future DWF workflow that persists design work directly into the canonical project-instance design, Delivery, and Topic files and migrates legacy DWF workspaces without retaining PIP as a permanent mode.       |
| [PROP-004 — IRS project instance runs](./PROP-004-irs-project-instance-runs.md)         | `design-draft` | `PLANNED`  | 3        | `PROP-002`, `PROP-003`, `PROP-005` | blocked by PROP-003, PROP-005 | Define IRS run state, evidence, implementation baselines, repository continuation, project-change review, and one-way legacy migration for the DLE project instance model.                                                  |
| [PROP-005 — DLE Distribution Kit](./PROP-005-dle-distribution-kit.md)                   | `design-draft` | `PLANNED`  | 3        | `PROP-002`                         | eligible                      | Define the curated DLE Distribution Kit contract for exact component requirements, integrity, compatible release sets, immutable installation, local binding, project bootstrap and adoption, routing, and skill discovery. |
| [PROP-006 — IRS next-action orientation](./PROP-006-irs-next-action-orientation.md)     | `design-draft` | `PLANNED`  | 3        | `PROP-001`, `PROP-004`             | blocked by PROP-004           | Define bounded read-only orientation that inspects a project-instance IRS run and always recommends one next safe action without beginning mutation.                                                                        |
...
| [PROP-002 — DLE project instance model](./PROP-002-dle-project-instance-model.md)                     | `implementation-ready` | 3        | none                | Establish the durable DLE project instance as the sole project authority and handoff unit, retire PIP from future DLE architecture, and define project identity, design/Delivery change detection, exact component requirements, new-machine continuation, one-way legacy migration, and coordinated release boundaries. |
...
| [PROP-008 — DLE project instance model and Distribution Kit terminology](./archive/implemented/PROP-008-dle-project-instance-and-distribution-kit-terminology.md) | `implemented` | 3        | `PROP-007`             | Adopt DLE project instance model and DLE Distribution Kit as the simple, responsibility-aligned names for the umbrella project model and its curated distribution and bootstrap concept.                                                                                                                              |
