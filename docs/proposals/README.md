...
| [PROP-008 — DLE project instance model and Distribution Kit terminology](./PROP-008-dle-project-instance-and-distribution-kit-terminology.md) | `implementation-ready` | 3        | `PROP-007`          | Adopt DLE project instance model and DLE Distribution Kit as the simple, responsibility-aligned names for the umbrella project model and its curated distribution and bootstrap concept.                                                                                                                |
