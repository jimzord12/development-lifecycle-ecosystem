...
| ------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------- | -------- | ---------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [PROP-002 — DLE project instance consumption profile](./PROP-002-dle-project-instance-consumption.md)                     | `design-draft` | `CHECKPOINTED` | 3        | none                   | eligible                      | Define an additional DLE consumption profile in which a durable project instance owns live design, Delivery, Topics, and implementation records near its implementation repositories. The instance is the default portable handoff unit for same-team, external, and zero-context continuation; a Portable Implementation Package is an optional bounded implementation export. |
