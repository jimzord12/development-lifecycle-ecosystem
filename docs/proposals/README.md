...
| ------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------- | -------- | ---------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [PROP-002 — DLE project instance consumption profile](./PROP-002-dle-project-instance-consumption.md)                     | `design-draft` | `CHECKPOINTED` | 3        | none                   | eligible                      | Define an additional same-team DLE consumption profile in which a durable project instance owns live design, Delivery, Topics, and implementation records near its implementation repositories. Team members continue from that instance without exchanging a Portable Implementation Package for ordinary same-team work. A Portable Implementation Package remains the deterministic export for external or package-based zero-context handoff. |
