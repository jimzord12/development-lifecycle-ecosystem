...
- [Co-located project DLE namespace](./co-located-project-dle-namespace.md) — same-team instance (PIP-like, no `.framework/`), Topics, user-scope router skill, CLI for init/docs/queries
